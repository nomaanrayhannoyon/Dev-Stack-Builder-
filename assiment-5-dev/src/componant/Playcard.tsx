...
const Playcard = ({ promiss }: CardProps) => {
  ...
  // Add technology to active stack selection
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      {/* Main Layout: 3 Columns Grid for Cards + 1 Column for Sidebar */}
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
        
        {/* Left Side Technology Cards (Span 3 Columns) */}
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {data.map((item) => {
            ...
            return (
              ...
              >
                <div>
                  {/* Card Header: Icon and Top Badge */}
                ...
                <div>
                  {/* Category, Level and Rating (Single Row) */}
                  ...
                  {/* Add to Stack Full-Width Button */}
                  <button
        ...
        {/* Right Side "Your Stack" Sidebar (Span 1 Column) */}
